...
public class WaterworksStuboutPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        xLabel1.setCaption("Sub Area");
        xLabel1.setExpression("#{ entity.subarea.code }");
        xLabel1.setVisibleWhen("#{ hasParent==true || mode != 'create' }");
        xLabel1.setPreferredSize(new java.awt.Dimension(0, 20));
        xFormPanel1.add(xLabel1);

        xLookupField2.setCaption("Sub Area");
        xLookupField2.setExpression("#{ entity.subarea.code }");
        xLookupField2.setHandler("waterworks_subarea:lookup");
        xLookupField2.setName("entity.subarea"); // NOI18N
