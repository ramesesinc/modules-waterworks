...
public class WaterworksSetupBalancePage extends javax.swing.JPanel {

    /**
     * Creates new form WaterworksBillCapture2Page
     */
    public WaterworksSetupBalancePage() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        xLabel22.setCaption("Until Year/Month");
        ...
        jPanel2.add(xFormPanel10, java.awt.BorderLayout.CENTER);
        ...
        xButton20.setVisibleWhen("#{ totalamount == 0  && fromBill == false}");
        xButton20.setText("Add Credit");
        jPanel16.add(xButton20);

        xButton21.setName("removeCredit"); // NOI18N
        xButton21.setVisibleWhen("#{ totalamount < 0 && fromBill == false }");
        ...
        xPanel1.setVisibleWhen("#{ fromBill == false }");
